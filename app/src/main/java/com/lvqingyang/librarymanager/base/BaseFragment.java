package com.lvqingyang.librarymanager.base;
...
import com.lvqingyang.librarymanager.tool.MySweetAlertDialog;
...
//        是否有menu，然后重写onCreateOptionsMenu, onOptionsItemSelected
    ...
    protected void showSuccDialog(int titleId,int contentId,SweetAlertDialog.OnSweetClickListener listener){
        if (null == mDialog) {
            mDialog = new MySweetAlertDialog(mAppCompatActivity);
        }
        mDialog.success(getString(titleId),getString(contentId),listener);
        mDialog=null;
    }

    protected void showSuccDialog(String title,String content,SweetAlertDialog.OnSweetClickListener listener){
        if (null == mDialog) {
            mDialog = new MySweetAlertDialog(mAppCompatActivity);
        }
        mDialog.success(title,content,listener);
        mDialog=null;
    }
